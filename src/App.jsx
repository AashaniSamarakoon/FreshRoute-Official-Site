...
function Icon({ name }) {
  const icons = {
    ...
    leaf: <path d="M5 19c7.5-.4 12.7-5.8 14-14-8.2 1.2-13.6 6.5-14 14Zm0 0c2.2-4.7 5.4-7.8 10-10" />,
    route: <path d="M4 16c3 0 3-4 6-4s3 4 6 4 3-4 4-4M7 6h.01M17 6h.01M8 6c0 1.5-3 3.3-3 5.8 0 1.9 1.4 3.7 3 3.7s3-1.8 3-3.7C11 9.3 8 7.5 8 6Zm9 0c0 1.5-3 3.3-3 5.8 0 1.9 1.4 3.7 3 3.7s3-1.8 3-3.7C20 9.3 17 7.5 17 6Z" />,
    scan: <path d="M7 4H5a1 1 0 0 0-1 1v2m13-3h2a1 1 0 0 1 1 1v2M7 20H5a1 1 0 0 1-1-1v-2m13 3h2a1 1 0 0 0 1-1v-2M7 12h10m-8-3h6m-5 6h4" />
  };
...
function ImageSlot({ image, alt = '', className = '' }) {
  return (
    <div className={`image-slot ${image ? 'has-image' : 'is-empty'} ${className}`}>
...
function Logo() {
  return (
    <a className="logo" href="#top" aria-label="FreshRoute home">
      <img className="logo-image" src="/FreshrouteLogo.png" alt="" aria-hidden="true" />
      <span><span className="logo-fresh">Fresh</span><span className="logo-route">Route</span></span>
    </a>
  );
}
...
function Header() {
  ...
  return (
    <header className={`site-header ${overHero ? 'is-over-hero' : 'is-scrolled'} ${open ? 'is-menu-open' : ''}`}>
    ...
    <section className="hero image-cover" id="top">
      <div className="hero-overlay">
        ...
        <p className="hero-copy">
          Pioneering a cleaner way to connect farmers, exporters, distributors, and buyers through responsive sourcing, routing, and quality workflows.
        </p>
      </div>
  ...
  return (
    <section className="white-section" id="platform">
      <div className="section-grid intro-grid">
        ...
        <div>
          <h2>Explore FreshRoute technology, which is reshaping fresh fruit logistics.</h2>
          <p>
            FreshRoute connects harvest availability, buyer demand, delivery routes, and quality checks in one clean operating flow.
          </p>
        </div>
      </div>
  ...
  return (
    <section className="white-section compact-section" id="process">
      <div className="center-copy">
        ...
        <h2>Check out FreshRoute modern sourcing solutions and see the core benefits.</h2>
      </div>
...
function ImageBand() {
  return (
    <section className="image-band image-cover">
      <div>
        <h2>Collaborate and learn from industry experts and produce partners.</h2>
        <a className="round-arrow" href="#solutions" aria-label="Explore partner solutions">
          <Icon name="arrow" />
        </a>
      </div>
    </section>
  ...
  return (
    <section className="white-section media-section" id="media">
      <div className="section-grid">
        ...
        <div>
          <h2>Be part of a dynamic community focused on advancing fresh produce logistics.</h2>
          <p>
            FreshRoute supports grower networks, pack houses, logistics teams, and buyers with a clear operating layer for daily fruit movement.
          </p>
        </div>
      </div>
      ...
      <div className="community-mosaic">
        {communityVisuals.map((visual) => (
          <article className={`community-card ${visual.className}`} key={visual.title}>
            <ImageSlot />
  ...
  return (
    <section className="dark-section" id="solutions">
      <div className="dark-intro">
        ...
        <h2>Innovative fruit sourcing solutions for achieving optimal growth and yield.</h2>
        <p>
          From partner onboarding to batch visibility, FreshRoute is designed for high-turnover produce movement.
        </p>
      </div>
  ...
  return (
    <section className="white-section impact-section" id="impact">
      <div className="impact-copy">
        ...
        <p>
          Batch notes, pickup visibility, and buyer-ready quality checks help every partner move with more confidence.
        </p>
  ...
  return (
    <section className="contact-section" id="contact">
      <div className="newsletter-panel">
        <h2>Get the latest FreshRoute updates by starting a supply conversation.</h2>
        <a className="action-pill" href={FACEBOOK_URL} target="_blank" rel="noreferrer">
          <span>Facebook</span>
          <Icon name="arrow" />
        </a>
      </div>
      ...
      <div className="contact-layout">
        <div>
          ...
          <p>
            Share your sourcing, export, retail, or logistics goals and we will help map the right FreshRoute workflow for your team.
          </p>
        </div>
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.utils.toArray('.white-section, .dark-section, .contact-section').forEach((section) => {
        const headingTargets = section.querySelectorAll('.section-kicker, h2, p');
      ...
      gsap.utils.toArray('.feature-image-card, .category-list article, .dark-card, .community-card, .quality-grid div, details').forEach((item) => {
        gsap.from(item, {
          y: 34,
          opacity: 0,
          duration: 0.72,
